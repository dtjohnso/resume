...
\noindent \textit{Young, educated professional with some management experience seeking a career change.}\\\\
...
% TODO: Rewrite to include more context for someone unaware of size of college, add more details about accomplishments (audit, charitable status, overseeing finances, etc.)
...
% With an average of 500 attendees on a Sunday morning, Meadowlands Baptist Church is a large church located in southeast Edmonton. My role at the church involved serving as administrative support to the senior pastor while also overseeing a variety of church operations. This included writing curriculum for adult education classes at the church, .......
...
\begin{itemize}
\item \href{http://www.etsjets.org/}{Evangelical Theological Society} (2015 -- present)
