...
\headedsection{
	\href{http://www.meadowlandsbaptist.com/}{Meadowlands Baptist Church} }
	{\textsc{Edmonton, \acr{AB}}}
	{
		{\bodytext{
		I taught adult Sunday School classes at my church on various biblical books, listed below. Generally, my goal in these classes was to help people see the flow of the passage and its application to daily life.


		\begin{multicols}{2}
		\begin{itemize}
			\item Psalms (Sept 2017--present)
			\item \href{http://blogs.duncanjohnson.ca/creeds/}{Faithful Sayings: Confessions of Faith and Sound Theology} (Jan--May 2017) 
			\item Romans (May--Dec 2016)
			\item Galatians (Jan--Apr 2016)
			\item 1 \& 2 Timothy, Titus (Aug--Nov 2015)
			\item 1 \& 2 Thessalonians (May--Jul 2015)
			\item John (Nov 2014--May 2015)
			\item 1, 2, 3 John (Aug--Nov 2014)
			\item 2 Corinthians (May--Aug 2014)
			\item 1 Corinthians (Jan--May 2014)
			\item Ephesians (Sept--Dec 2013)
			\item 1 \& 2 Peter, Jude (May--Sept 2013)
			\item Mark (Jan--May 2013)
			\item Colossians \& Philemon (Aug--Dec 2012)
			\item Philippians (May--Aug 2012)
			\item James (Feb--May 2012)
		\end{itemize}
		\end{multicols}
		}}
	}
